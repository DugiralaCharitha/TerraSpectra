...
import CropImagePrediction from '../components/Prediction/CropImagePrediction'
import { FARM_METADATA } from '../services/gisService'
    ...
    <main className="dashboard">
      ...
      <header className="dashboard-header">
        ...
        <nav className="dashboard-nav">
          ...
          <button onClick={() => scrollToSection('prediction')}>Crop Prediction</button>
      ...
      <section className="dashboard-content">
        ...
        <CropImagePrediction
          farmId={FARM_METADATA?.farm_id}
          farmName={FARM_METADATA?.farm_name}
        />
